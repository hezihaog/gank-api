 ...
 * FileName: EasySparseArrayCompat
 * Date: on 2018/3/1  下午10:15
 * Auther: zihe
 * Descirbe:
 ...
 */
public class EasySparseArrayCompat<E> implements Cloneable {
     ...
     */
    public EasySparseArrayCompat(int initialCapacity) {
    ...
    public EasySparseArrayCompat<E> clone() {
        EasySparseArrayCompat<E> clone = null;
        try {
            clone = (EasySparseArrayCompat<E>) super.clone();
    ...
    public boolean containsKey(int key) {
        //查询key在数组中的位置，如果找不到的话，返回负数，注意不是固定的-1
